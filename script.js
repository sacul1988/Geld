document.addEventListener('DOMContentLoaded', () => {
    ...
    addExpenseBtn.addEventListener('click', () => {
        ...
        if (expense && expense > 0) {
            ...
            // LOGIK: Das Tagesbudget bleibt FIX, wie beim Start berechnet.
            // Wir aktualisieren hier nur die Anzeige, aber berechnen die Rate NICHT neu.
            const fixedDailyRate = parseFloat(localStorage.getItem('currentDailyBudget')) || 0;
            dailyBudgetEl.innerText = `€ ${fixedDailyRate.toFixed(2)}`;
    ...
    function checkSavingsStatus() {
        ...
        if (startTimestamp && initialDailyRate) {
            ...
            while (currentDate <= calculationEnd) {
                ...
                // Wir nutzen immer die allererste Rate, die beim Start berechnet wurde (initialDailyRate).
                // Diese bleibt bis zum Monatsende fix.
